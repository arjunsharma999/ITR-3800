...
#define ITR_3800_MAX_NR_OF_POINTS                      (512)
...
typedef struct {
    float32_t f32_angleAzimuth_deg;     /* [deg] */
    float32_t f32_angleElevation_deg;   /* [deg] */
    float32_t f32_range_m;              /* [m]*/
    float32_t f32_velocity_mps;         /* [m/s] */
    float32_t f32_signal_dB;            /* [dB] */
    float32_t f32_snr_dB;               /* [dB] */
    float32_t f32_rcs_m2;               /* [m2] */
    uint16_t ui16_rangeIndex;           /* [#] */
    uint16_t ui16_dopplerIndex;         /* [#] */
    float32_t f32_reserved1;
    float32_t f32_reserved2;
} ITR3800_Point_t;

union ITR3800_PointCloudError_u {
    ITR3800_PointCloudError_t pointCloudError;
    uint32_t dummy;
};
...
typedef struct {
    ...
    uint16_t reserved_0;
    uint32_t systemState;
    ITR3800_PointCloudError_u pointCloudError;
    uint32_t timestamp_ms;
    uint16_t frameID;
    uint16_t nrOfPoints;
    ITR3800_Point_t pointCloud[ITR_3800_MAX_NR_OF_POINTS];
    float reserved0;
    float reserved1;
    float reserved2;
    float reserved3;
} ITR3800_PointCloud_t;
