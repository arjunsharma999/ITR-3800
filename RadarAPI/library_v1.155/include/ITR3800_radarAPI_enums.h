...
typedef enum {
    ITR3800_POINT_CLOUD_OUTPUT_OFF = 0,
    ITR3800_POINT_CLOUD_OUTPUT_ON
} ITR3800_PointCloudOutput_t;

typedef enum {
    ITR3800_CAMERA_HD       = 0,
    ITR3800_CAMERA_FULLHD
} ITR3800_CamResolution_t;
...
typedef enum {
    ITR3800_API_POINT_CLOUD_OK = 0x00,
    ITR3800_API_POINT_CLOUD_FULL = 0x01,
    ITR3800_API_POINT_CLOUD_ALREADY_REQUESTED = 0x02,
    ITR3800_API_POINT_CLOUD_NOT_ACTIVE = 0x03,
    ITR3800_API_POINT_CLOUD_DATA_CORRUPTED = 0x04
} ITR3800_PointCloudError_t;
