...
RADAR_API_EXPORT ITR3800_Result_t ITR3800_setPreferredNtpServer(APIHandle_t pHandle, char *ntpServerName, uint8_t length);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_getPreferredNtpServer(APIHandle_t pHandle, char *ntpServerName, uint8_t *length);
...
RADAR_API_EXPORT ITR3800_Result_t ITR3800_setHeartbeatMessageEnable(APIHandle_t pHandle, uint8_t enable);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_getHeartbeatMessageEnable(APIHandle_t pHandle, uint8_t *enable);
...
RADAR_API_EXPORT ITR3800_Result_t ITR3800_setIperf3ServerEnable(APIHandle_t pHandle, bool_t enable);

RADAR_API_EXPORT ITR3800_Result_t ITR3800_setEventMessageUdpOutputEnable(APIHandle_t pHandle, bool_t enable);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_getEventMessageUdpOutputEnable(APIHandle_t pHandle, bool_t *enable);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_setEventMessageRS485OutputEnable(APIHandle_t pHandle, bool_t enable);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_getEventMessageRS485OutputEnable(APIHandle_t pHandle, bool_t *enable);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_setEventMessageTcpOutputEnable(APIHandle_t pHandle, bool_t enable);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_getEventMessageTcpOutputEnable(APIHandle_t pHandle, bool_t *enable);
...
/* camera control */
RADAR_API_EXPORT ITR3800_Result_t ITR3800_setCameraEnable(APIHandle_t pHandle, uint8_t enable, ITR3800_CamResolution_t resolution);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_getCameraEnable(APIHandle_t pHandle, uint8_t *enable, ITR3800_CamResolution_t *resolution);
...
/* point cloud */
RADAR_API_EXPORT ITR3800_Result_t ITR3800_setPointCloudOutputMode(APIHandle_t pHandle, ITR3800_PointCloudOutput_t mode);
RADAR_API_EXPORT ITR3800_Result_t ITR3800_getPointCloud(APIHandle_t pHandle, ITR3800_PointCloud_t *pPointCloud);
